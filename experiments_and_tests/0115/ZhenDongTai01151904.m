...
t00 = Minute*60+Second-3558+772.86+0.03-566.78+0.009;%这一句在合成时须作人工调整；
interval = t00;
...
dx2=mean(dx1);
dx3=(dx-dx2)*(-0.5);
interval=interval-9.5+6;%手机改时间用
plot(interval,-dx3,'r');%%%%%%%%%
%x=interval;
axis([0,12,-10,10]);%坐标轴显示范围，这个先注释，改完时间后再去掉注释
%datetick('x','HH:MM:SS');
